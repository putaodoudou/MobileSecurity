package practice.mobilesecurity.chapter09.service;
...
import practice.mobilesecurity.chapter09.EnterPswActivity;
...
public class AppLockService extends Service {
    ...
    public void onCreate() {
        ...
        IntentFilter filter = new IntentFilter("practice.mobilesecurity.applock");
    ...
    class AppLockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("practice.mobilesecurity.applock".equals(intent.getAction())) {
