package practice.mobilesecurity.chapter05;
...
import practice.mobilesecurity.chapter05.adapter.ScanVirusAdapter;
import practice.mobilesecurity.chapter05.dao.AntiVirusDao;
import practice.mobilesecurity.chapter05.entity.ScanAppInfo;
import practice.mobilesecurity.chapter05.utils.Constant;
import practice.mobilesecurity.chapter05.utils.MD5Utils;

public class VirusScanSpeedActivity extends Activity implements OnClickListener{
    protected static final int SCAN_BEGIN = 100;
    protected static final int SCAN_ING = 101;
    ...
    private Handler mHandler = new Handler() {
        ...
        private void saveScanTime() {
            ...
            edit.putString(Constant.LAST_SCAN, currentTime);
            edit.commit();
        }
    };
    ...
    private void initView() {
        ...
        mProcessTV = (TextView) findViewById(R.id.tv_scan_process);
        mScanAppTV = (TextView) findViewById(R.id.tv_scan_app);
        mCancleBtn = (Button) findViewById(R.id.btn_cancle_scan);
        mCancleBtn.setOnClickListener(this);
        mScanListView = (ListView) findViewById(R.id.lv_scan_app);
        adapter = new ScanVirusAdapter(mScanAppInfos, this);
        mScanListView.setAdapter(adapter);
        mScanningIcon = (ImageView) findViewById(R.id.imgv_scanning_icon);
        startAnim();
    }
